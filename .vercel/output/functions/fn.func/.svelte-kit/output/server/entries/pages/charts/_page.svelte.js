...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  subTitle.set("Placemarks Data");
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="columns"><div class="column">${validate_component(Card, "Card").$$render($$result, { title: "Placemarks By Level" }, {}, {
    default: () => {
      return `${validate_component(Base, "Chart").$$render($$result, { data: data.byLevel, type: "bar" }, {}, {})}`;
    }
  })}</div> <div class="column">${validate_component(Card, "Card").$$render($$result, { title: "Placemarks By Trektype" }, {}, {
    default: () => {
      return `${validate_component(Base, "Chart").$$render($$result, { data: data.byTrektype, type: "pie" }, {}, {})}`;
    }
  })}</div></div>`;
});
export {
