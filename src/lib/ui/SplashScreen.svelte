    ...
    <div class="container has-text-centered">
      <div class="columns is-vcentered">
        <div class="column is-5">
          <figure class="image">
            <img class="object-fit" src="/mangerton.png" alt="mangerton" />
          </figure>
        </div>
        <div class="column is-6 is-offset-1">
          <h1 class="title is-2 mb-5">
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/rusticramblerslogo1.png" alt="Rustic Ramblers Image" style="width: 300px; height: 180px;" class="mr-5">
        </h1>
        <h2 class="subtitle is-4 mt-2">Welcome to Rustic Ramblers</h2>
